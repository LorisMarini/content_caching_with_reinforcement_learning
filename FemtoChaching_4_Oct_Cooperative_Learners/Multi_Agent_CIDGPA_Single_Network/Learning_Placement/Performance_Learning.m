...
Fig_File_Name_1 = fullfile(Results_Directory, ['CDF_NAWD_DGPA_' Learning_Setup '_'  num2str(SST_L) 'N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_1);
xlabel('AWDs');
ylabel('P( NAWD <= x)');
grid on;
...
Fig_File_Name_2 = fullfile(Results_Directory, ['Avg_NAWD_DGPA_'  Learning_Setup '_' num2str(SST_L) 'N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_2);
xlabel('Gamma');
ylabel('Average NAWD');
grid on;
...
Fig_File_Name_3 = fullfile(Results_Directory, ['Avg_Complexity_DGPA_'  Learning_Setup '_' num2str(SST_L) '_N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_3);
xlabel('Gamma');
ylabel('Iterations');
grid on;
