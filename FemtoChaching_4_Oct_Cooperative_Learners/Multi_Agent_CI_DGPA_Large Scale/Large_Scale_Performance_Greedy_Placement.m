function [ Avg_Net_AWD_Greedy, Net_AWD_Greedy ] = Large_Scale_Performance_Greedy_Placement( Net_Number, N_Networks, Results_Directory, Network_Delays, Gamma_ZipF, SST_G, M, H, N, S  )
...
Fig_File_Name_3 = fullfile(Results_Directory, ['CDF_NAWD_Greedy' num2str(SST_G) '_Network_' num2str(Net_Number) '_of_' num2str(N_Networks)  '_N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_3);
xlabel('AWDs');
ylabel('P( NAWD <= x)');
grid on;
...
Fig_File_Name_4 = fullfile(Results_Directory, ['Avg_NAWD_Greedy' num2str(SST_G) '_Network_' num2str(Net_Number) '_of_' num2str(N_Networks)  '_N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_4);
xlabel('Gamma');
ylabel('Average NAWD');
grid on;
...
Fig_File_Name_5 = fullfile(Results_Directory, ['Avg_Complexity_Greedy' num2str(SST_G) '_Network_' num2str(Net_Number) '_of_' num2str(N_Networks)  '_N_' num2str(N) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title_5);
xlabel('Gamma');
ylabel('Average NAWD');
grid on;
