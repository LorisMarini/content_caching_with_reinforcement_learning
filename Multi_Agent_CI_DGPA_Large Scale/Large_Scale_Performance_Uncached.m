function [ Net_AWD_Uncached ] = Large_Scale_Performance_Uncached( Net_Number, N_Networks,Results_Directory, Network_Delays, Gamma_ZipF, M, H, N, S  )
...
Fig_File_Name = fullfile(Results_Directory, ['NAWD_Uncached_N_' num2str(N)  '_Network_' num2str(Net_Number) '_of_' num2str(N_Networks) '_H' num2str(H)  '_M' num2str(M) '.fig']);
title(Title);
xlabel('Gamma');
ylabel('Average NAWD');
grid on;
